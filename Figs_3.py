...
f1_S1a_vanDantzig_DH=plt.plot(df_DH[DH],df_DH[investmentCost]/dollarUnit,color='c',marker='.',linestyle='None',label=investlabel,linewidth=0.5)
...
plt.plot(df_DH[DH],df_DH[totalDamage]/dollarUnit,color='grey',marker='.',linestyle='None',label=damagelabel,linewidth=0.5)
plt.plot(df_DH[DH], (df_DH[totalDamage]+df_DH[investmentCost])/dollarUnit,c = 'k',marker='.',linestyle='None',label=netlabel,linewidth=0.5)
...
#print(df_RH_RP_WH_DB_DH[RH].count())
top=df_RH_RP_WH_DB_DH[RH].count()
for x in range(0,top-1):
  if (df_RH_RP_WH_DB_DH.loc[x,DB]-df_RH_RP_WH_DB_DH.loc[x,WH])<.05:
    df_RH_RP_WH_DB_DH.loc[x,RH]=0.05

#print(df_RH_RP_WH_DB_DH.loc[1,RH])
...
fig5=plt.figure()
f5=plt.scatter(df_RH_RP_WH_DB_DH[investmentCost]/dollarUnit, df_RH_RP_WH_DB_DH[WH]+df_RH_RP_WH_DB_DH[b]+df_RH_RP_WH_DB_DH[DH],c = 'grey',marker='+',s=10, label=None)
plt.scatter(df_RH_RP_WH_DB_DH[investmentCost]/dollarUnit, df_RH_RP_WH_DB_DH[WH]+df_RH_RP_WH_DB_DH[r],c = 'b',marker='+',s=(10*df_RH_RP_WH_DB_DH[RP]), label=None)
...
plt.scatter(df_RH_RP_WH_DB_DH[investmentCost]/dollarUnit, df_RH_RP_WH_DB_DH[WH]+df_RH_RP_WH_DB_DH[b],c = 'lightgrey',marker='.',s=10, label=None)

leg2=plt.legend(handles=[handle_Dike, handle_Resistance, handle_Withdrawal,handle_Dike_Base],loc='right', shadow=False)
leg2.get_frame().set_linewidth(0.0)
plt.xlabel(investAxlabel)
plt.ylabel("Elevation above seawall(m)")
plt.xlim(0,1.3*investLim)
plt.ylim(0,16)
plt.gca().spines['right'].set_visible(False)
plt.gca().spines['top'].set_visible(False)
...
#figS6=plt.figure()
fS6=scatter2d(model_RH_RP_WH_DB_DH,output_RH_RP_WH_DB_DH,x=investmentCost,y=r,c=RP,s=WH,show_legend=True)
...
f6=scatter3d(model_RH_RP_WH_DB_DH, output_RH_RP_WH_DB_DH, x=DH, y=WH, z=r, s=b, c=RP, show_legend=True,linestyle=':',linewidth=0.5)
